...
public class RXTXCommDriver implements CommDriver {
    private static final Logger LOGGER = LoggerFactory.getLogger(RXTXCommDriver.class);
    ...
    static {
        ...
        LOGGER.info("RXTXCommDriver : static initializer.");
    ...
    private final String[] getValidPortPrefixes(String CandidatePortPrefixes[]) {
        /*
         * getScannedBufferSize() is the number of prefixes ( COM, cua, ttyS, ...) not the number of devices (ttyS0,
         * ttyS1, ttyS2, ...)
         * 
	...
	*  From the NullDriver.java CommAPI sample.
    ...
    public void initialize() {
        ...
        LOGGER.info("RXTXCommDriver:initialize(), osName: {}", osName);
    ...
    private void registerScannedPorts(int PortType) {
        ...
        LOGGER.info("scanning device directory " + deviceDirectory + " for ports of type " + PortType);
    ...
    public CommPort getCommPort(String PortName, int PortType) {
        LOGGER.info("RXTXCommDriver:getCommPort(" + PortName + "," + PortType + ")");
        ...
        try {
            switch (PortType) {
                ...
                default:
                    LOGGER.warn("unknown PortType  " + PortType + " passed to RXTXCommDriver.getCommPort()");
                    break;
            }
        }
        catch (PortInUseException e) {
            LOGGER.warn("Port " + PortName + " in use by another application");
        }
        return null;
    }
