...
class CommPortEnumerator implements Enumeration {
    ...
    CommPortEnumerator(final Object sync) {
        this.sync = sync;
    }
    ...
    public Object nextElement() {
        ...
        synchronized (/* CommPortIdentifier.Sync */sync) {
            if (index != null)
                index = index.next;
            else
    ...
    public boolean hasMoreElements() {
        if (debug)
            System.out
                .println("CommPortEnumerator:hasMoreElements() " + CommPortIdentifier.CommPortIndex == null ? false : true);
        synchronized (/* CommPortIdentifier.Sync */sync) {
            if (index != null)
