...
public class CommPortIdentifier extends Object /* extends Vector? */
{
    ...
    static {
        ...
        LOGGER.info("CommPortIdentifier:static initialization(), OS: {}, arch: {}", OS, arch);

        synchronized (Sync) {
            LOGGER.info("Load the driver.");
            ...
            try {
                ...
                LOGGER.warn("Load gnu.io.RXTXCommDriver failed.", e);
            }

            if (OS.toLowerCase().indexOf("linux") == -1) {
                LOGGER.info("Have not implemented native_psmisc_report_owner(PortName)); in CommPortIdentifier");
            }
    ...
    static public Enumeration getPortIdentifiers() {
        LOGGER.info("static CommPortIdentifier:getPortIdentifiers()");
        ...
        synchronized (Sync) {
            ...
            try {
                ...
                LOGGER.error("Load gnu.io.RXTXCommDriver failed.", e);
                System.err.println(e + " thrown while loading " + "gnu.io.RXTXCommDriver");
                System.err.flush();
            }
        }
        return new CommPortEnumerator(Sync);
    }
